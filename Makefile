...
SRC_LIB=$(SRC_PATH)/kernels/sequence_alignment_kernel.cu $(SRC_PATH)/kernels/sequence_packing_kernel.cu $(SRC_PATH)/kernels/garbage_collection.cu $(wildcard $(SRC_PATH)/*.cu) utils/verification.c utils/device_query.cu
