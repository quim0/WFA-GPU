...
SRC_LIB=$(SRC_PATH)/kernels/sequence_alignment_kernel.cu $(SRC_PATH)/kernels/sequence_packing_kernel.cu $(wildcard $(SRC_PATH)/*.cu) lib/alignment_results.c lib/aligner.c utils/cigar.c utils/verification.c utils/device_query.cu
